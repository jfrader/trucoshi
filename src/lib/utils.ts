...
export type MemoizeMinute = <TFunction extends (...args: any[]) => any>(
  fn: TFunction
) => TFunction
...
interface IHandWinnerState {
  rounds: Array<{
    tie: boolean
    unbeatable: boolean
    winner: Pick<IPlayer, "teamIdx"> | null
  }>
  flor: {
    winner: Pick<ITeam, "id"> | null
    state: number
    answer: boolean | null
  }
}
...
export function checkHandWinner(hand: IHandWinnerState, forehandTeamIdx: 0 | 1): null | 0 | 1 {
